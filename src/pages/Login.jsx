...
import loginImg from '../assets/login_r_img.svg';
            ...
            <div className="w-screen h-screen dark:bg-zinc-700 bg-zinc-100 relative">
                ...
                <div className="w-screen h-screen absolute top-0 left-0">
                    <div className="w-full h-full flex justify-center items-center overflow-auto">
                        <div className=" max-w-3xl w-full h-[500px] mx-auto flex shadow-[0px_0px_10px_2px] shadow-zinc-600 dark:shadow-zinc-800 rounded-md">
                            {/* left img */}
                            ...
                            {/* right form */}
                            <div className="w-full md:w-[50%] bg-zinc-100 dark:bg-zinc-800 rounded-md md:rounded-s-none">right</div>
                        </div>
                    </div>
                </div>
            </div>
